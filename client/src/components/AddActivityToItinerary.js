...
function AddActivityToItinerary({ onAddItinerary }) {
  ...
  function handleSubmit(e) {
    ...
    dateTime.setHours(parseInt(formData.activity_itinerary_times_attributes[0].time.split(":")[0]));
    dateTime.setMinutes(parseInt(formData.activity_itinerary_times_attributes[0].time.split(":")[1]));
